...
export default function ClientsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Modal 1: Create New Client (Complete Form with Basic Info, Billing, Locations, Documents) */}
      <Dialog
        open={isAddOpen}
      ...
      >
        <div className="mt-2 max-h-[80vh] overflow-y-auto pr-1">
          <ClientForm
            onSuccess={() => {
              setIsAddOpen(false)
              showNotification("Client account registered successfully.")
              fetchClients()
            }}
          />
        </div>
